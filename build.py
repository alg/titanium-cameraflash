...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.noizeramp.js')
	...
	f = os.path.join(cwd,'Classes','ComNoizerampCameraflashModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.noizeramp.js']
